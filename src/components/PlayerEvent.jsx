...
export default function PlayerEvent({
  ...
  return (
    <div
      className={`player-event-container ${combatStatus.toLowerCase()} ${resultCombat.toLowerCase()}`}
    >
      <div className="event-gear-section">
        <div className="title">
          {killerName} - ({killerIp} IP)
        </div>
        <div className="gear-items">{renderKillerItems}</div>
      </div>
      ...
      <div className="event-gear-section">
        <div className="title">
          {victimName} - ({victimIp} IP)
        </div>
        <div className="gear-items">{renderVictimItems}</div>
      </div>
    </div>
  )
}
